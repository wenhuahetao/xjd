...
{
	$http = 'http://121.40.119.148/api.php'; // 短信接口
	$key = $GLOBALS['_CFG']['ecsdxt_user_name']; // 用户账号
	...
	//file_put_contents("sms_log.log",$mobile. iconv("utf-8","gb2312",$content),FILE_APPEND);
