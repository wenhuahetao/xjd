...
<div class="main-div">
  <table width="100%">
    <tr>
      ...
      <span style="float:right;"><img src="images/stars<?php echo $this->_var['msg']['comment_rank']; ?>.gif" /></span>
    </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="center">
     <?php if ($this->_var['supplier_commentshow']): ?>
...
<table border="0" align="center">
  ...
  <tr>
    <td align="right"><?php echo $this->_var['lang']['user_name']; ?>:</td>
  ...
  <tr>
    <td align="right"><?php echo $this->_var['lang']['reply_content']; ?>:</td>
    <td><textarea name="content" cols="50" rows="4" wrap="VIRTUAL" style="margin:5px;"><?php echo $this->_var['reply_info']['content']; ?></textarea><span class="require-field">*</span></td>
  </tr>
  <?php if ($this->_var['reply_info']['content']): ?>
  <tr>
    <td>&nbsp;</td>
