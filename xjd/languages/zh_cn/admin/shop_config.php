...
$_LANG['cfg_name']['ecsdxt_user_name'] = 'KEY';
$_LANG['cfg_desc']['ecsdxt_user_name'] = '<a href="http://www.sjczpt.com" target="_blank">点此处注册并登录短信平台，即可在后台“api文档”处获取key值。</a>';

$_LANG['cfg_name']['ecsdxt_pass_word'] = '';
$_LANG['cfg_desc']['ecsdxt_pass_word'] = '';

$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手机号码';
$_LANG['cfg_desc']['sms_shop_mobile'] = '请先注册手机短信服务再填写手机号码';

$_LANG['cfg_name']['sms_sign'] = '短信验证码模板';
$_LANG['cfg_desc']['sms_sign'] = '提示：短信内容需联系客服备案后才能正常发送，短信技术支持QQ：10027135';
